                                ...
                                if self.state in self.escape:
                                    if not nextchar:
                                        ...
                                        if self in self.quotes and nextchar != self.state and nextchar != escapedstate:
                                            ...
                                            continue
                                            if not self.state in ('a', 'c') or nextchar:
                                                self.state = None
                                                    ...
                                                    if nextchar in self.commenters:
                                                        ...
                                                        if self.posix:
                                                            ...
                                                            if self.state == 'c':
                                                                ...
                                                                if self.posix and nextchar in self.quotes:
                                                                    self.state = nextchar
                                                                    continue
                                                                    if self.posix and nextchar in self.escape:
                                                                        ...
                                                                        self.state = nextchar
                                                                        continue
                                                                        if (nextchar in self.wordchars and nextchar in self.quotes or self.whitespace_split) and nextchar not in self.punctuation_chars:
                                                                            self.token += nextchar
                                                                            continue
...
def join(split_command):
    ...
    return ' '.join((lambda .0: pass)(split_command))
