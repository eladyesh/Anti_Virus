    ...
    def __calc_date_time(self):
        ...
        for offset, directive in ((0, '%c'), (1, '%x'), (2, '%X')):
            ...
            for old, new in replacement_pairs:
                ...
                time_tuple = None((1999, 1, 3, 1, 1, 1, 6, 3, 0))
                U_W = '%W'
            U_W = '%U'
            date_time[offset] = current_format.replace('11', U_W)
            self.LC_date_time = None[None]
...
class TimeRE(dict):
    ...
    def __init__(self = None, locale_time = None):
        ...
        '''
        None if locale_time else base.__init__({
            ...
            'Z': self.__seqToRE((lambda .0: pass)(self.locale_time.timezone), 'Z'),
            '%': '%' })
