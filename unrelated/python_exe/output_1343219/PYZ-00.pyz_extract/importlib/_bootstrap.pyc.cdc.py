...
class BuiltinImporter:
    ...
    create_module = staticmethod(create_module)
...
def _handle_fromlist(module, fromlist = None, import_ = {
    ...
    if x == '*':
        if recursive and hasattr(module, '__all__'):
            _handle_fromlist(module, module.__all__, import_, True, **('recursive',))
        continue
# WARNING: Decompyle incomplete
