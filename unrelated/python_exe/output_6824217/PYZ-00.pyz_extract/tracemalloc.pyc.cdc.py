...
class Statistic:
    ...
    def __eq__(self, other):
        return None if not isinstance(other, Statistic) else self.count == other.count
...
class StatisticDiff:
    ...
    def __eq__(self, other):
        return None if not isinstance(other, StatisticDiff) else self.count_diff == other.count_diff
...
class Filter(BaseFilter):
    ...
    def _match_traceback(self, traceback):
        if self.all_frames:
            if None((lambda .0 = None: pass# WARNING: Decompyle incomplete
)(traceback)):
    ...
    def _match(self, trace):
        ...
        if self.domain is not None:
            return None if self.inclusive else domain != self.domain
...
class Snapshot:
    ...
    def _filter_trace(self, include_filters, exclude_filters, trace):
        if not include_filters and None((lambda .0 = None: pass# WARNING: Decompyle incomplete
)(include_filters)):
            return False
        if None and None((lambda .0 = None: pass# WARNING: Decompyle incomplete
)(exclude_filters)):
            return False
